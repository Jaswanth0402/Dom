...
upbtn.setAttribute("class","btn btn-sm btn-success")


document.getElementById("saveupdate").innerHTML=""

document.getElementById("saveupdate").appendChild(upbtn)
  ...
  let rowdata = rowvalue
    ...
    fetch("https://6451f642a2860c9ed4fe7357.mockapi.io/user/Curd" + "/" + id, {
      ...
      .then((response) => {
       ...
       rowdata.cells[0].innerHTML =id
        rowdata.cells[1].innerHTML =Name.value   
        rowdata.cells[2].innerHTML =email.value
        rowdata.cells[3].innerHTML = password.value 
       get()
